...
<body id="page-top">
    ...
    <div class="container-fluid">
          ...
          <div class="card-body">
            ...
            <table class="center">
                <tr>
                    ...
                    <td></td>
                    <td><asp:TextBox CssClass="form-control" ID="nameTextBox" runat="server" placeholder="Enter Category Name"></asp:TextBox></td>
                </tr>
                <tr>
        ...
        <asp:GridView  width="100%" cellspacing="0" CssClass="table table-bordered" ID="catagoryGridView" DataKeyNames="Name" OnRowDataBound="catagoryGridView_OnRowDataBound" OnSelectedIndexChanged="catagoryGridView_OnSelectedIndexChanged" runat="server" AutoGenerateColumns="False">
            <Columns>
                    ...
                    nameTextBox:
                     {
                         ...
                         minlength: "Category Name length must be at least of 4 characters long!"
                     }
                }
            });
        });
